  ...
  return (
    <div className="mt-24 py-4 px-2">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-4 gap-5 px-6 py-10 text-gray-800">
        <div className=" flex flex-col bg-[#D6D6D8] items-center justify-center md:flex-row md:justify-between  md:max-h-[14rem] col-auto md:col-span-2 px-4 bg-cat1">
        ...
        <div className="w-full lg:order-last bg-[#212121]  py-6 col-auto md:col-span-2 text-white  flex flex-col justify-center items-center bg-cat3">
        ...
        <div className="w-full h-full bg-[#EFE1C7] row-span-1  md:row-span-2 bg-cat2 text-lg">
          <div className="px-4 py-4">
            <p>Flex Sweatshirt</p>
            <p > <del>$100.00</del> &nbsp;&nbsp;&nbsp; <b className="no-underline ">$75.00</b> </p>
          </div>
          <div className="lg:w-58 xl:w-64">
        ...
        <div className="w-full h-full  bg-[#D7D7D9] row-span-1 md:row-span-2 bg-cat4">
        <div className="px-4 py-4">
